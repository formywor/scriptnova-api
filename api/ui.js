...
const { BUILD, getConfig, incrementCounter, dateKey, trackError, getLicenseMeta } = require('./_admin');
...
function randomNonceB64url(bytes=16){ return b64urlFromBuffer(crypto.randomBytes(bytes)); }
...
module.exports = async function handler(req,res){
  ...
  await incrementCounter(redis, dateKey('sn:metric:ui'));
