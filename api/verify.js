...
async function resolveLicense(redis, lic) {
  ...
  const allowedKeys = ["PRO-Z", "PRO-SNOVAPROKEY", "PRO-SENG1", "PRO-MH1", "PRO-MOTOGOODATGAME", "PRO-SCRIPTNOVAPEAK", "PRO-LUKASISCOOL", "PRO-MH2", "PRO-SHAYGAY", "PRO-KOFS", "PRO-SIGMATOILETHOWEY", "PRO-JADEN"];
