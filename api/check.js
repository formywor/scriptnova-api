...
async function resolveLicense(redis, lic) {
  ...
  const allowedKeys = ["PRO-DEV", "PRO-SNOVAPROKEY", "PRO-SENG3", "PRO-MH4", "PRO-MOTOGOODATGAME", "PRO-LUKASISCOOL", "PRO-MH3", "PRO-SHAYGAY", "PRO-KOFS", "PRO-SIGMATOILETHOWEY", "PRO-JADEN", "PRO-ADEL", "PRO-CAMERON"];
