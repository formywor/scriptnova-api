...
function catalog(records) {
  const demo = {id:"scriptnovaa", name:"ScriptNovaa demonstration", url:"https://scriptnovaa.com/sponsor-demo", description:"Our own demonstration, not an outside sponsor.", mode:"embed"};
